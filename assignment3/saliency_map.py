...
# dont understand the point of this
...
# what is integrated gradients? llooks garbage
# where is abs?
# may be change to saliency?
saliency_grads = Saliency(model)
# could have called saliency.attribute directly.. but never mind
# i think n_steps is not required
attr_ig = compute_attributions(saliency_grads, X_tensor, target=y_tensor)
# rename title
visualize_attr_maps('visualization/saliency_grads_captum.png', X, y, class_names, [attr_ig], ['Saliency Map'])
##############################################################################
#                             END OF YOUR CODE                               #
##############################################################################
